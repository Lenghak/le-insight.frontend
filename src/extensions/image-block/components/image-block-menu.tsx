...
import { getRenderContainer } from "@/common/lib/get-render-container";

import { type MenuProps } from "@/extensions/menus/types";
    ...
    >
      ...
      >
        ...
        <ImageBlockWidth
          ...
          value={parseInt(editor.getAttributes("imageBlock").width as string)}
        />
      </Toolbar.Wrapper>
    </BaseBubbleMenu>
  );
